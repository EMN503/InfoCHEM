...
def imput_rule():
    os.system("python src/command.py")
...
img4 = ImageTk.PhotoImage(Image.open("src/images/Shield.png"))
label4 = Label(frame4, image=img4, bg="#424F55")
label4.pack()

addimg = ImageTk.PhotoImage(Image.open("src/images/Add.png"))
...
startimg = ImageTk.PhotoImage(Image.open("src/images/play.png"))
...
stopimg = ImageTk.PhotoImage(Image.open("src/images/stop.png"))
